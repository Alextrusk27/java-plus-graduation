...
public class PrivateCommentController {
    ...
    public CommentDto createComment(
        ...
        CommentDto result = service.create(CreateCommentParams.of(userId, eventId, body));
    ...
    public CommentDto updateComment(
        ...
        CommentDto result = service.updatePrivate(PrivateUpdateCommentParams.of(userId, commentId, body));
